            ...
            >
              ...
              <div className="flex flex-col items-center md:items-start w-full">
                ...
                <div className="flex flex-wrap gap-4 justify-center md:justify-start" dir="ltr">
                  {/* GitHub */}
                  <a href="https://github.com/MohamedWahid777" target="_blank" rel="noopener noreferrer" aria-label="GitHub" onClick={trackGitHubClick} className="relative h-12 rounded-full border border-white/10 flex items-center text-on-surface-variant hover:text-[var(--github-icon-hover)] hover:border-white/40 hover:bg-white/5 transition-[max-width,border-color,background-color,color] duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group overflow-visible lg:overflow-hidden max-w-[48px] lg:hover:max-w-[200px]">
                  ...
                  {/* LinkedIn */}
                  <a href="https://www.linkedin.com/in/mohamed-wahid-11469a3b8" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" onClick={trackLinkedInClick} className="relative h-12 rounded-full border border-white/10 flex items-center text-on-surface-variant hover:text-[#0077b5] hover:border-[#0077b5]/50 hover:bg-[#0077b5]/10 transition-[max-width,border-color,background-color,color] duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group overflow-visible lg:overflow-hidden max-w-[48px] lg:hover:max-w-[200px]">
                    <div className="w-12 h-12 flex items-center justify-center shrink-0 relative z-10">
                  ...
                  {/* Facebook */}
                  <a href="https://www.facebook.com/profile.php?id=61589148441332" target="_blank" rel="noopener noreferrer" aria-label="Facebook" onClick={trackFacebookClick} className="relative h-12 rounded-full border border-white/10 flex items-center text-on-surface-variant hover:text-[#1877f2] hover:border-[#1877f2]/50 hover:bg-[#1877f2]/10 transition-[max-width,border-color,background-color,color] duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group overflow-visible lg:overflow-hidden max-w-[48px] lg:hover:max-w-[200px]">
                    <div className="w-12 h-12 flex items-center justify-center shrink-0 relative z-10">
                  ...
                  {/* WhatsApp */}
                  <a href="https://wa.me/201063841779" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" onClick={trackWhatsAppClick} className="relative h-12 rounded-full border border-white/10 flex items-center text-on-surface-variant hover:text-[#25D366] hover:border-[#25D366]/50 hover:bg-[#25D366]/10 transition-[max-width,border-color,background-color,color] duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group overflow-visible lg:overflow-hidden max-w-[48px] lg:hover:max-w-[200px]">
                    <div className="w-12 h-12 flex items-center justify-center shrink-0 relative z-10">
                  ...
                  {/* Email */}
                  <a href="mailto:wahadmomo@gmail.com" aria-label="Email" onClick={trackEmailClick} className="relative h-12 rounded-full border border-white/10 flex items-center text-on-surface-variant hover:text-primary hover:border-primary/50 hover:bg-primary/10 transition-[max-width,border-color,background-color,color] duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group overflow-visible lg:overflow-hidden max-w-[48px] lg:hover:max-w-[200px]">
                    <div className="w-12 h-12 flex items-center justify-center shrink-0 relative z-10">
